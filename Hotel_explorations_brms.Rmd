...
prior <- c(
 ...
 fit = brm(bf(
   ...
   data = detection_data, cores = 4, chains = 4,  backend = "cmdstanr", threads = threading(4), prior = prior, file = "fit_1half")
 ...
 fit = brm(bf(
   ...
   data = detection_data, cores = 4, chains = 4,  backend = "cmdstanr", threads = threading(4), file = "fit_non_h")
